       ...
       <div class="row g-2">
           <div class="col-md-3">
               <div class="t-products p-2">
                   ...
                   <div class="p-lists">
                    <div class="d-flex justify-content-between mt-2"> <span> <a href="{{route('baby')}}">Baby`s Fashion</a></span> <span>23</span> </div>
                    <div class="d-flex justify-content-between mt-2">  <a href="{{route('kids')}}"><span>Kid`s Fasion</span> </a> <span>46</span> </div>
                    <div class="d-flex justify-content-between mt-2">  <a href="{{route('mens')}}"><span>Men`s Fashion</span></a> <span>13</span> </div>
                    <div class="d-flex justify-content-between mt-2">  <a href="{{route('women')}}"><span>Women`s Fashion</span></a> <span>33</span> </div>
                   </div>
               </div>
