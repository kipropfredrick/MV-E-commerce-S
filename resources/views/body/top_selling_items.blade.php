...
<body>
        ...
        * {
        ...
        <div class="card">
            ...
            <img class="img-fluid w-100" src="https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/11045448/2020/1/27/6e16cf87-9f1f-46cb-9afa-8d79ee9b24431580121584122-Nike-Men-Off-White-LEGEND-REACT-2-SHIELD-Running-Shoes-15715-1.jpg" alt="Sample">
            <h4 class="mb-0"><span class="badge badge-primary badge-pill badge-news">Sale</span></h4>
            <a href="#!">
            </a>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-body text-center">
            ...
            <button type="button" class="btn btn-light btn-sm mr-1 mb-2">
              <i class="fas fa-info-circle pr-2"></i>Detail
